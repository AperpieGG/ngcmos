...
first_star_time = data_table['Time_JD'][0]  # Time for the first star
first_star_flux = data_table['Relative_Flux'][0]  # Flux for the first star

# Plot flux versus time for the first star
plt.figure(figsize=(8, 6))
plt.plot(first_star_time, first_star_flux, marker='o', linestyle='-', color='blue')
plt.xlabel('Time (JD)')
