...
#     return image_data, date_obs
#
#
# def register_images(images):
#     reference_image, reference_date = images[0]
#     reference_data = reference_image
#
#     registered_images_list = [(reference_data, reference_date)]
#     for img, date_obs in images[1:]:
#         shift_result = chi2_shift(reference_data, img)
#         shifted_image_data = np.roll(img, shift_result[0].astype(int), axis=0)
#         registered_images_list.append((shifted_image_data, date_obs))
#
...
#
#     object_text = ax.text(0.02, 0.02, '', transform=ax.transAxes, color='white',
