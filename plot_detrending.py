...
def plot_lc_with_detrend(table, gaia_id_to_plot, bin_size):
    ...
    ax1.legend()
    ax2.errorbar(jd_mid, dt_flux, yerr=dt_fluxerr, fmt='.', color='black', alpha=0.3)
    ax2.errorbar(time_binned, dt_flux_binned, yerr=dt_fluxerr_binned, fmt='o', color='black', markerfacecolor='white')
